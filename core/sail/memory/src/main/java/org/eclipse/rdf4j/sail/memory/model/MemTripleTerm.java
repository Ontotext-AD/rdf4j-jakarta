...
/**
 * A MemoryStore-specific implementation of {@link TripleTerm}.
 *
...
public class MemTripleTerm extends MemResource implements TripleTerm {
	...
	/**
	 * The list of statements for which this MemTripleTerm is the object.
	 */
	transient private final MemStatementList objectStatements = new MemStatementList();

	public MemTripleTerm(Object creator, MemResource subject, MemIRI predicate, MemValue object) {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof TripleTerm) {
			TripleTerm that = (TripleTerm) other;
