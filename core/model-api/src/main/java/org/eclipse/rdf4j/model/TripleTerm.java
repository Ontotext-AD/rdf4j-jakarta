 ...
 * <p>
 * Additional utility functionality for working with {@code TripleTerm} objects is available in the
...
public interface TripleTerm extends Resource {
	 ...
	 * @return {@code true} if the {@code other} object is an instance of {@code TripleTerm} and if their
